...
\label{sec:intro}
\textcolor{red}{TODO: fix introduction, make more clear what TLS is used for and what makes this attack so dangerous}
...
\textcolor{red}{First explain the results from Lucky Thirteen, than discuss how to build the attack using multi-channel}

Lucky Thirteen~\cite{alfardan2013lucky}

Multi-channel attack~\cite{canvel2003password}
